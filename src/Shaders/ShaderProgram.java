...
public abstract class ShaderProgram {
	...
	public ShaderProgram(String vertexFile, String fragmentFile) {
		...
		System.out.println(TextColor.YELLOW+"SHADER PATH:"+vertexFile+" and "+fragmentFile+TextColor.RESET); //TODO Debug
	...
	private int loadShader(String file, int type) {
		System.out.println(TextColor.GREEN+"LOAD SHADER:"+file+" "+type+TextColor.RESET); //TODO DEBUG
		...
		try {
			...
			e.printStackTrace();
			System.err.println(TextColor.RED+"Could not load shader file!"+TextColor.RESET);
			System.exit(-1);
		}
		...
		if (GL20.glGetShaderi(shaderID, GL20.GL_COMPILE_STATUS) == GL11.GL_FALSE) {
			...
			System.err.println(TextColor.RED+"Could not compile shader!"+TextColor.RESET);
			System.exit(-1);
